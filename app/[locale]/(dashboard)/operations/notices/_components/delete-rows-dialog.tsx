...
import { deleteNotices } from '@/lib/services/default/features/notices';
...
export function DeleteRowsDialog<TData extends Notice>({ table }: ToggleDeleteActionProps<TData>): JSX.Element {
